...
test.describe.skip('Warehouse / Inbound Shipments Flow', () => {
  test('should navigate to Inbound Shipments, apply filters, and verify results', async ({ authenticatedPage, baseURL }) => {
    const url = new URL(baseURL);

    // 1. Navigate directly to Inbound Shipments
    try {
  ...
  test('should navigate to Inbound Shipments, apply alternative filters (2nd option), and verify results', async ({ authenticatedPage, baseURL }) => {
    const url = new URL(baseURL);
  ...
  test('should navigate to Inbound Shipments, apply alternative filters (3rd option), and verify results with assertions', async ({ authenticatedPage, baseURL }) => {
    const url = new URL(baseURL);
